...
#define N                    2640 // Nombre de Variables
#define K                    1320 // Nombre de Checks   
#define ONE_COUNT            7920 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 6
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   110
#define TAILLE_RAM_PNODE     9936 // = taille ram interleaver
#define TAILLE_VALID_RAM     2640
#define NB_CYCLE_EXEC        69
