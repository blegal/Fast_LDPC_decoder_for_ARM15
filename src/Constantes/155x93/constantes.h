...
#define N                    155 // Nombre de Variables
#define K                    93 // Nombre de Checks   
#define ONE_COUNT            465 // Nombre de Messages 
#define nb_MAX_un_dans_ligne 5
#define nb_FU                24
#define optim_chrgt          0
#define nb_var_tot_par_ram   6
#define TAILLE_RAM_PNODE     1920 // = taille ram interleaver
#define TAILLE_VALID_RAM     168
#define NB_CYCLE_EXEC        16
